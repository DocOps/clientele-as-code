...
+
 wget https://github.com/DocOps/clientele-as-code/archive/refs/heads/main.zip && unzip main.zip && mv clientele-as-code-main/* . && rm -rf clientele-as-code-main main.zip README.adoc spec
